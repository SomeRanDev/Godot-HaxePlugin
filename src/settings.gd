...
const SETTING_SOURCE_PATH = "haxe/source_path";
...
static func get_source_path() -> String:
	return ProjectSettings.get_setting(SETTING_SOURCE_PATH, "");
...
static func setup_settings():
	...
	init_settings(SETTING_SOURCE_PATH, TYPE_STRING, "", PROPERTY_HINT_GLOBAL_DIR);
